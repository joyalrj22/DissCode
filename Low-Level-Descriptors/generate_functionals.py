...
folder_lld_features = ['audio_features/audio_features_mfcc/',
                       'audio_features/audio_features_egemaps/',
                       'visual_features/']

folder_functionals  = ['audio_features/audio_features_mfcc_functionals/',
                       'audio_features/audio_features_egemaps_functionals/',
